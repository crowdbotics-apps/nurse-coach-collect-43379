...
## Project Structure
    ...
    ├── nurse_coach_collect_43379  # Django project configurations
...
1. Clone this repo and `cd nurse_coach_collect_43379`
...
2. Clone this repo and `cd nurse_coach_collect_43379`
